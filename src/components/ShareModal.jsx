...
export default function ShareModal({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/85 p-4 backdrop-blur-md animate-fadeIn">
      <div className="w-full max-w-[500px] rounded-3xl border border-white/[0.1] bg-[#0E0F18] p-6 sm:p-7 shadow-[0_24px_70px_rgba(0,0,0,0.9),0_0_30px_rgba(124,92,255,0.12)] max-h-[90vh] overflow-y-auto">
        {/* Cabeçalho */}
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-[12px] text-mutedDim">
                Partilha com a tua comunidade e redes sociais
              </p>
            </div>
          </div>
          <button
        ...
        <div className="mb-5 rounded-2xl border border-white/[0.08] bg-[#131422] p-4 shadow-inner">
          ...
          {cleanDesc ? (
            <div className="mb-3 rounded-xl bg-black/40 p-2.5 border border-white/[0.06]">
          ...
          <div className="text-[11.5px] font-mono text-accent/90 bg-accent/10 px-3 py-2 rounded-xl border border-accent/20 truncate">
            {targetUrl}
          </div>
        </div>
        ...
        <div className="mb-5 grid grid-cols-1 sm:grid-cols-2 gap-2.5">
          ...
          <button
            ...
            className={`flex h-10 items-center justify-center gap-2 rounded-xl px-4 text-[13px] font-bold transition-all shadow-md ${
              copiedFull
                ? "bg-teal text-black"
          ...
          >
            ...
            <span>{copiedFull ? "Copiado! ✓" : "Copiar com Texto"}</span>
          </button>
          ...
          <button
            ...
            className={`flex h-10 items-center justify-center gap-2 rounded-xl border px-4 text-[13px] font-bold transition-all ${
              copiedLink
                ...
                : "border-white/[0.08] bg-[#131422] hover:bg-[#18192A] hover:text-white text-muted hover:border-white/20"
            }`}
          >
            {copiedLink ? <Check size={15} /> : <Copy size={15} />}
            <span>{copiedLink ? "Link Copiado! ✓" : "Copiar só Link"}</span>
          </button>
        </div>
        ...
        {typeof navigator !== "undefined" && typeof navigator.share === "function" && (
          <div className="mb-4">
            <button
              ...
              className="w-full flex h-10 items-center justify-center gap-2 rounded-xl border border-white/[0.08] bg-[#131422] hover:bg-[#18192A] px-4 text-[13px] font-semibold text-white transition-all hover:border-white/20 shadow-sm"
            >
        ...
        {onOpenExport && (
          <div className="mb-5">
            <button
              ...
              className="w-full flex h-11 items-center justify-between px-4 rounded-xl border border-accent/40 bg-accent/10 hover:bg-accent hover:text-black text-white transition-all group shadow-sm"
            >
              ...
              <span className="text-[11px] font-bold text-accent group-hover:text-black transition-colors bg-accent/20 group-hover:bg-black/20 px-2 py-0.5 rounded-lg">
                1080p / 2K
              </span>
            </button>
          </div>
        ...
        <div>
          <span className="mb-2.5 block text-[11px] font-bold uppercase tracking-wider text-mutedDim">
            Partilha Rápida em Redes:
          </span>
          <div className="grid grid-cols-2 gap-2.5">
            {socialLinks.map((s) => (
              <a
                ...
                className={`flex h-10 items-center gap-2.5 rounded-xl border border-white/[0.08] bg-[#131422] px-3.5 text-[13px] font-semibold text-text hover:bg-[#18192A] hover:border-white/20 transition-all ${s.color}`}
              >
        ...
        <div className="mt-6 flex justify-end pt-2 border-t border-white/[0.06]">
          <button
            type="button"
            onClick={onClose}
            className="h-10 px-5 rounded-xl border border-white/[0.08] bg-[#131422] hover:bg-white/[0.08] text-[13px] font-semibold text-muted hover:text-white transition-colors"
          >
